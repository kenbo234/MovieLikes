            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="username" class="col-md-4 col-form-label text-md-end">{{ __('名前') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="zipcode" class="col-md-4 col-form-label text-md-end">{{ __('郵便番号') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="prefecture" type="text" class="form-control @error('prefecture') is-invalid @enderror" name="prefecture" value="{{ old('prefecture') }}" required>
                        ...
                        <div class="row mb-3">
                            <label for="city" class="col-md-4 col-form-label text-md-end">{{ __('市町村') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="housenumber" class="col-md-4 col-form-label text-md-end">{{ __('番地') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="buildingname" class="col-md-4 col-form-label text-md-end">{{ __('建物名') }}</label>

                            <div class="col-md-6">
                                <input id="buildingname" type="text" class="form-control @error('buildingname') is-invalid @enderror" name="buildingname" value="{{ old('buildingname') }}" >
