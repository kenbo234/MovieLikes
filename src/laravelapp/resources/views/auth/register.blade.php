                ...
                <div class="card">
                    ...
                    <div class="card-body" style="background-color: rgb(241, 235, 244);">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="username" class="col-md-4 col-form-label text-md-end">{{ __('名前') }}<span
                                        class="required" style="color: red;">*</span></label></label>
                            ...
                            <div class="row mb-3">
                                <label for="password-confirm"
                                    class="col-md-4 col-form-label text-md-end">{{ __('確認パスワード') }}<span class="required"
                            ...
                            <div class="row mb-3">
                                <label for="prefecture"
                                    class="col-md-4 col-form-label text-md-end">{{ __('都道府県') }}<span class="required"
                                        style="color: red;">*</span></label>

                                <div class="col-md-6">
                                    <input id="prefecture" type="text"
                                        class="form-control @error('prefecture') is-invalid @enderror" name="prefecture"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="buildingname" type="text"
                                        class="form-control @error('buildingname') is-invalid @enderror"
                                        name="buildingname" value="{{ old('buildingname') }}">
